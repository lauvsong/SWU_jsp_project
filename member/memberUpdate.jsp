...
<script>
	function MySubmit(index){
		if(index==1)
			document.regFrm.action="memberUpdateProc.jsp";
		else
			document.regFrm.action="memberDelete.jsp";
					...
					<td align="center" valign="middle" bgcolor="#FFFFCC">
						<table border="1" cellpadding="2" align="center" width="600">
							...
							<tr>
								...
								<input type="button" value="수정완료" onclick=MySubmit(1)> &nbsp; &nbsp; 
								<input type="reset" value="다시쓰기">
								<% if (session.getAttribute("admin")==null) {%>
									<input type="button" value="탈퇴" onclick=MySubmit(2)></td>
								<%} %>
							</tr>
						</table>
					</td>
